...
const Globe3D = () => {
  ...
  useEffect(() => {
    ...
    // Glow effect
    const glowGeometry = new THREE.SphereGeometry(globeRadius + 0.1, 32, 32);
    ...
    locations.forEach((loc) => {
      ...
      const lineGeometry = new THREE.BufferGeometry().setFromPoints([
        ...
        position.clone().multiplyScalar(0.9),
      ]);
    ...
    for (let i = 0; i < particleCount; i++) {
      ...
      const r = globeRadius + 0.4 + Math.random() * 0.4;
