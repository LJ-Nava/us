      ...
      <div className="cta-section__container">
        <div className="cta-section__card">
          ...
          <div className="cta-section__cta-wrapper">
            <button className="cta-section__btn cta-section__btn--primary" onClick={handleWhatsApp} aria-label="Contactar por WhatsApp">
            ...
            <button className="cta-section__btn cta-section__btn--secondary" onClick={handlePortfolio} aria-label="Ver nuestro portfolio">
