      ...
      <div className="cta-section__container">
        <div className="cta-section__card">
          ...
          <h2 className="cta-section__title">
            ...
            <br />
            <span className="cta-section__title-gradient">resultados medibles</span>
          </h2>

          {/* Description */}
          <p className="cta-section__description">
            Agenda una consulta estratégica gratuita. Analizamos tu proyecto,
            identificamos oportunidades y te presentamos una propuesta
