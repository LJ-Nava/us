    ...
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 24 24" fill="#E10098">
          <path d="M14.051 2.751l4.935 2.85c.816-.859 2.173-.893 3.032-.077.148.14.274.301.377.477.589 1.028.232 2.339-.796 2.928-.174.1-.361.175-.558.223v5.699c1.146.273 1.854 1.423 1.58 2.569-.048.204-.127.4-.232.581-.592 1.023-1.901 1.374-2.927.782-.196-.113-.375-.259-.526-.428l-4.905 2.832c.372 1.12-.238 2.333-1.362 2.706-.198.066-.406.1-.615.1-1.182 0-2.14-.957-2.14-2.139 0-.218.033-.433.098-.64l-4.905-2.832c-.769.903-2.13 1.012-3.033.243-.16-.136-.297-.296-.41-.47-.591-1.022-.241-2.332.783-2.926.175-.101.365-.178.563-.227v-5.699c-1.146-.273-1.854-1.423-1.58-2.569.048-.204.127-.4.232-.581.595-1.021 1.901-1.37 2.924-.78.198.114.378.261.53.431l4.938-2.85C7.726 1.636 8.34.433 9.549.062c.271-.083.554-.106.834-.069 1.175.155 1.999 1.234 1.843 2.41-.027.206-.082.408-.163.598l4.938 2.85c.395-.398.917-.628 1.463-.644.552-.016 1.089.184 1.504.558l.077.077z"/>
        </svg>
      )
    },
    {
    ...
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 24 24" fill="#764ABC">
          <path d="M16.634 16.504c.87-.075 1.543-.818 1.5-1.705-.043-.872-.784-1.55-1.656-1.507-.828.043-1.499.74-1.499 1.58v.244c-.627 1.247-1.59 2.162-3.063 2.943-.96.502-1.962.746-2.965.674-1.63-.093-2.864-.93-3.587-2.406-.9-1.844-.772-3.63.372-5.323.858-1.272 2.096-2.064 2.974-2.542-.053-.212-.138-.56-.181-.857-3.22 1.556-4.79 4.33-4.426 7.58.232 2.063 1.146 3.75 2.743 4.994 1.702 1.323 3.635 1.758 5.688 1.274 2.256-.53 3.955-1.835 5.1-3.95zm5.076-3.618c-1.72-2.022-4.254-3.136-7.138-3.136h-.374c-.21-.424-.638-.71-1.124-.71-.697 0-1.265.574-1.265 1.28 0 .71.568 1.278 1.265 1.278.513 0 .95-.312 1.153-.765h.41c1.73 0 3.368.47 4.827 1.373 1.117.69 1.95 1.6 2.46 2.706.432.93.517 1.846.254 2.713-.4 1.32-1.395 2.057-2.804 2.057-.895 0-1.738-.302-2.178-.502l-.695.824c.908.457 1.83.7 2.762.7 1.05 0 2.012-.282 2.83-.86 1.074-.76 1.723-1.903 1.89-3.318.2-1.73-.368-3.358-1.273-4.64zM8.104 17.96c-.697 0-1.266.574-1.266 1.278 0 .71.569 1.28 1.266 1.28.696 0 1.265-.57 1.265-1.28v-.255c1.47-.638 2.516-1.59 3.197-2.892.87-1.666 1.01-3.413.412-5.205-.595-1.79-1.802-3.14-3.497-3.904-1.376-.62-2.825-.773-4.233-.46l-.452.85c.476-.09.957-.137 1.437-.137 1.587 0 3.07.557 4.28 1.623 1.51 1.332 2.28 3.127 2.156 5.073-.093 1.453-.656 2.71-1.672 3.736-.52.526-1.163.945-1.893 1.236v.255c-.001.697-.57 1.27-1.267 1.27-.015-.697-.585-1.267-1.233-1.268z"/>
        </svg>
      )
    },
    {
      name: 'Stripe',
      icon: (
        <svg viewBox="0 0 24 24" fill="#008CDD">
