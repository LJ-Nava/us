      ...
      <div className="footer__container">
        <div className="footer__inner">
          ...
          <div className="footer__cta">
            ...
            <button className="footer__cta-btn" onClick={handleWhatsApp} aria-label="Contactar por WhatsApp">
          ...
          <div className="footer__grid">
            ...
            <div className="footer__brand">
              <Link to="/" className="footer__logo" aria-label="Plexify Studio - Ir al inicio">
                <img
                  src={LogoImg}
          ...
          <div className="footer__bottom">
            <div className="footer__bottom-left">
              <p className="footer__copyright">
                © {currentYear} Plexify Studio. {t('footer.rights')}
              </p>
            </div>
            <div className="footer__bottom-right">
              <Link to="/legal#privacy" className="footer__legal-link">{t('footer.privacy')}</Link>
              <Link to="/legal#terms" className="footer__legal-link">{t('footer.terms')}</Link>
            </div>
          </div>
        </div>
      </div>
